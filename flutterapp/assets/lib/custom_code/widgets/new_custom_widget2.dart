...
class SelectedIngredientsModel extends ChangeNotifier {
  List<IngredientEntry> _selectedIngredients = [];

  List<IngredientEntry> get selectedIngredients => _selectedIngredients;
...
class _NewCustomWidgetState extends State<NewCustomWidget> {
  ...
  void _showIngredientDialog(String selectedIngredient, BuildContext context) {
    showDialog(
      context: context,
      builder: (context) {
        double quantity = 1.0;
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              child: Text('Add'),
              onPressed: () {
                Provider.of<SelectedIngredientsModel>(context, listen: false)
                    .addIngredient(
                  IngredientEntry(
        ...
        children: [
          Autocomplete<String>(
            ...
            onSelected: (String selection) {
              _showIngredientDialog(selection, context);
            },
            fieldViewBuilder:
          ...
          Expanded(
            child: Consumer<SelectedIngredientsModel>(
              builder: (context, model, child) => ListView.builder(
                itemCount: model.selectedIngredients.length,
                itemBuilder: (context, index) {
                  final ingredient = model.selectedIngredients[index];
                  return ListTile(
                    title: Row(
                      children: [
                        Expanded(
                    ...
                    trailing: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Provider.of<SelectedIngredientsModel>(context,
                                    listen: false)
