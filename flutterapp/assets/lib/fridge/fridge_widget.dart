...
class _FridgeWidgetState extends State<FridgeWidget> {
  ...
  List<String> ingredients = ['Milk']; // Updated list to only include Milk
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: TextField(
            ...
            style: TextStyle(fontSize: 18, color: FlutterFlowTheme.of(context).primaryText),
          ),
          centerTitle: true,
          elevation: 0.0,
        ),
...
Widget _buildRecipeCard() {
    ...
    String description = "A simple and delightful iced coffee with whipping cream, perfect for summer.";
    double rating = 4.5;
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(recipeTitle, style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold)),
          SizedBox(height: 4.0),
          Text(authorName, style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.normal)),
          SizedBox(height: 8.0),
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: NetworkImage("https://media.istockphoto.com/id/483014582/photo/iced-coffee-with-whipping-cream.jpg?s=1024x1024&w=is&k=20&c=nPBZMC-YZCA7wjssHCh5UDWoEhv11GqYrwJ6s0ZIplk="),
                fit: BoxFit.cover
              ),
              borderRadius: BorderRadius.circular(8.0), // Optional: rounding the corners of the image
            ),
          ),
          SizedBox(height: 8.0),
          Text(description, maxLines: 3, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 14.0)),
          SizedBox(height: 8.0),
          Row(
            children: [
